# Module 07 - Templates and Structural Directives

## Projects:

|                                                  |                                       |
| ------------------------------------------------ | ------------------------------------- |
| [fun with templates](./projects/fun-with-templates/) | Templates, Containers and Star Directives |
...
* We saw how to create the embedded views programatically
    - `ViewContainerRef.createEmbeddedView(template)` creates an embedded view from a template, receives an object that will be used as data context inside the template
